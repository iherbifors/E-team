...
public class Infix2Postfix2 {
    ...
    public static void main(String[] args) {
        // 원본 테스트
        String exp = "12 + 2.5 * 5";
        System.out.printf("%s => %s %n", exp, Infix2Postfix2.convert(exp));

        // 변경: 괄호 테스트 추가
        String exp2 = "(2 + 3) * 4";
        System.out.printf("%s => %s %n", exp2, Infix2Postfix2.convert(exp2));

        String exp3 = "2 * (3 + 4)";
        System.out.printf("%s => %s %n", exp3, Infix2Postfix2.convert(exp3));

        String exp4 = "(1 + 2) * (3 + 4)";
        System.out.printf("%s => %s %n", exp4, Infix2Postfix2.convert(exp4));
